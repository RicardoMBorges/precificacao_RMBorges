...
def default_consumables_ref() -> pd.DataFrame:
    ...
    rows = [
        ...
        {"Categoria": "Padrões e Controles", "Item": "GIGA KIT MetabolomicX quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 49200.00, "Unidades_por_formato": 1, "Custo_unitario": 600.00, "Unidade_operacional": "un"},
        {"Categoria": "Padrões e Controles", "Item": "GIGA KIT MetabolomicX (Shipping) quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 492000.00, "Unidades_por_formato": 1, "Custo_unitario": 6000.00, "Unidade_operacional": "un"},
        {"Categoria": "Padrões e Controles", "Item": "GIGA KIT MetabolomicX (less samples) quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 106600.00, "Unidades_por_formato": 1, "Custo_unitario": 1300.00, "Unidade_operacional": "un"},
