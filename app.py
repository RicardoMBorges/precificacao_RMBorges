...
def default_consumables_ref() -> pd.DataFrame:
    ...
    rows = [
        ...
        {"Categoria": "Padrões e Controles", "Item": "MEGA KIT Whishart quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 300.00, "Unidades_por_formato": 1, "Custo_unitario": 0.00, "Unidade_operacional": "un"}
        {"Categoria": "Padrões e Controles", "Item": "PRIME KIT Whishart quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 250.00, "Unidades_por_formato": 1, "Custo_unitario": 0.00, "Unidade_operacional": "un"}
