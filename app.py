...
def default_consumables_ref() -> pd.DataFrame:
    ...
    rows = [
        ...
        {"Categoria": "Padrões e Controles", "Item": "GIGA KIT (less samples) Whishart quantitative metabolomics", "Fonte": "WHISHART", "Formato": 1, "Preco_unitario": 106600.00, "Unidades_por_formato": 1, "Custo_unitario": 1300.00, "Unidade_operacional": "un"},
